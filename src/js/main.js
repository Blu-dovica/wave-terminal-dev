...
$(function() {
 ...
 type = async function(text, paginate = true) {
    ...
    for (var i in split) {
        ...
        if (!isEmpty) {
            await innerType(terminal, split[i])
        }
        else {
 ...
 innerType = function (terminal, text) {
